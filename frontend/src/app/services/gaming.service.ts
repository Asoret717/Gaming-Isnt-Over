...
export class GamingService {
  ...
  setSearchedProduct(product:string){this.searchedProduct=product.toLowerCase();}
  getSearchedProduct(){return this.searchedProduct;}
  ...
  createTechnology(technology: Technology): Observable<Technology>{
    ...
    bodyEncoded.append("fileName", technology.fileName);
